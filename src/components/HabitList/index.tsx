...
export function HabitList({ date, onCompletedChanged }: HabitListProp) {
    ...
    async function handleToggleHabit(habitId: string) {
        ...
        const isHabitAlreadyCompleted = habitsInfo!.completedHabits?.includes(habitId) ? true : false;
                ...
                habitsInfo && habitsInfo?.possibleHabits.map(habit => {
                    return (
                        <Checkbox.Root
                            ...
                            checked={habitsInfo.completedHabits.includes(habit.id) ? true : false}
